...
public class ModularFireBlock extends FireBlock implements Unregisterable {
    ...
    public static FireType findAppropriateFireType(BlockView view, BlockPos pos, @Nullable FireType parent) {
